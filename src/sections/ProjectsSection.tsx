...
export function ProjectsSection() {
  return (
    <section id="projects" className="cv-auto relative overflow-hidden py-16">
      <div className="relative z-10 space-y-10 px-6 sm:px-12 md:px-16 w-full max-w-7xl mx-auto">
          ...
          {projects.map((project) => (
            <Reveal key={project.title}>
              <article
                ...
                className="flex h-full flex-col rounded-3xl border border-white/10 bg-black/60 backdrop-blur-md p-5 shadow-[0_0_45px_rgba(0,0,0,0.85)] transition hover:border-white/40 hover:bg-black/80 sm:p-6"
              >
